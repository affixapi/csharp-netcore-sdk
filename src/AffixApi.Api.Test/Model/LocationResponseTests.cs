...
namespace AffixApi.Api.Test.Model
{
    ...
    public class LocationResponseTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test "IsType" LocationResponse
            //Assert.IsType<LocationResponse>(instance);
        }
