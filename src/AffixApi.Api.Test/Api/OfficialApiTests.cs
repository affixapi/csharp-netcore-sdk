...
{
    /// <summary>
    ///  Class for testing OfficialApi
    /// </summary>
    /// <remarks>
    /// This file is automatically generated by OpenAPI Generator (https://openapi-generator.tech).
    /// Please update the test case below to test the API endpoint.
    /// </remarks>
    public class OfficialApiTests : IDisposable
    {
        private OfficialApi instance;

        public OfficialApiTests()
        {
            instance = new OfficialApi();
        }
        ...
        /// <summary>
        /// Test an instance of OfficialApi
        /// </summary>
        [Fact]
        public void InstanceTest()
        {
            // TODO uncomment below to test 'IsType' OfficialApi
            //Assert.IsType<OfficialApi>(instance);
        }
