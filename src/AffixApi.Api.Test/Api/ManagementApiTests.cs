...
namespace AffixApi.Api.Test.Api
{
    ...
    public class ManagementApiTests : IDisposable
    {
        ...
        {
            // TODO uncomment below to test 'IsType' ManagementApi
            //Assert.IsType<ManagementApi>(instance);
        }
        ...
        public void CallClientTest()
        {
            ...
            //var response = instance.CallClient();
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.Disconnect();
        ...
        {
            // TODO uncomment below to test the method and replace null with proper value
            //var response = instance.Introspect();
        ...
        public void UpdateClientTest()
        {
            ...
            //var response = instance.UpdateClient(clientRequest);
            //Assert.IsType<ClientResponse>(response);
        }
    }
}
