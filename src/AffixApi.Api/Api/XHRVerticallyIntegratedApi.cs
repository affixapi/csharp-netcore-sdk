...
namespace AffixApi.Api.Api
{
    ...
    /// </summary>
    public interface IXHRVerticallyIntegratedApiSync : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="AffixApi.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="employmentStatus">Optional query parameter. Use to enable server-side filtering of the &#x60;employment_status&#x60; attribute. Will only include individuals with that attribute explicitly set (ie if an individuals has a &#x60;null&#x60;, it will not be returned if this parameter is set)  (optional)</param>
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IXHRVerticallyIntegratedApiAsync : IApiAccessor
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public interface IXHRVerticallyIntegratedApi : IXHRVerticallyIntegratedApiSync, IXHRVerticallyIntegratedApiAsync
    {
    ...
    /// Represents a collection of functions to interact with the API endpoints
    /// </summary>
    public partial class XHRVerticallyIntegratedApi : IXHRVerticallyIntegratedApi
    {
        private AffixApi.Api.Client.ExceptionFactory _exceptionFactory = (name, response) => null;

        /// <summary>
        /// Initializes a new instance of the <see cref="XHRVerticallyIntegratedApi"/> class.
        /// </summary>
        /// <returns></returns>
        public XHRVerticallyIntegratedApi() : this((string)null)
        {
        }
        ...
        /// </summary>
        /// <returns></returns>
        public XHRVerticallyIntegratedApi(String basePath)
        {
        ...
        /// <returns></returns>
        public XHRVerticallyIntegratedApi(AffixApi.Api.Client.Configuration configuration)
        {
        ...
        public XHRVerticallyIntegratedApi(AffixApi.Api.Client.ISynchronousClient client, AffixApi.Api.Client.IAsynchronousClient asyncClient, AffixApi.Api.Client.IReadableConfiguration configuration)
        {
        ...
        public AffixApi.Api.Client.ApiResponse<List<EmployeeResponse>> XhrEmployees20230301WithHttpInfo(EmploymentStatusNotNullNotNullable? employmentStatus = default(EmploymentStatusNotNullNotNullable?))
        {
            ...
            {
                localVarRequestOptions.QueryParameters.Add(AffixApi.Api.Client.ClientUtils.ParameterToMultiMap("", "employment_status", employmentStatus));
            }
        ...
        public AffixApi.Api.Client.ApiResponse<List<PayslipResponse>> XhrPayslips20230301WithHttpInfo(string payrunId)
        {
            ...
            if (payrunId == null)
                throw new AffixApi.Api.Client.ApiException(400, "Missing required parameter 'payrunId' when calling XHRVerticallyIntegratedApi->XhrPayslips20230301");
