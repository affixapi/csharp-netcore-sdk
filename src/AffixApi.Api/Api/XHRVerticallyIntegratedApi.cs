    ...
    public partial class XHRVerticallyIntegratedApi : IXHRVerticallyIntegratedApi
    {
        ...
        public AffixApi.Api.Client.ApiResponse<EmployeeResponse> XhrCreateEmployee20230301WithHttpInfo(CreateEmployeeRequest createEmployeeRequest)
        {
            ...
            if (createEmployeeRequest == null)
                throw new AffixApi.Api.Client.ApiException(400, "Missing required parameter 'createEmployeeRequest' when calling XHRVerticallyIntegratedApi->XhrCreateEmployee20230301");
