...
namespace AffixApi.Api.Api
{
    ...
    public partial class CoreApi : ICoreApi
    {
        ...
        /// <returns></returns>
        public CoreApi(AffixApi.Api.Client.Configuration configuration)
        {
        ...
        public CoreApi(AffixApi.Api.Client.ISynchronousClient client, AffixApi.Api.Client.IAsynchronousClient asyncClient, AffixApi.Api.Client.IReadableConfiguration configuration)
        {
        ...
        {
            AffixApi.Api.Client.ApiResponse<List<Object>> localVarResponse = ProvidersWithHttpInfo();
        ...
        /// <exception cref="AffixApi.Api.Client.ApiException">Thrown when fails to make API call</exception>
        /// <returns>ApiResponse of List&lt;Object&gt;</returns>
        public AffixApi.Api.Client.ApiResponse<List<Object>> ProvidersWithHttpInfo()
        {
        ...
        {
            AffixApi.Api.Client.ApiResponse<List<Object>> localVarResponse = await ProvidersWithHttpInfoAsync(cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;Object&gt;)</returns>
        public async System.Threading.Tasks.Task<AffixApi.Api.Client.ApiResponse<List<Object>>> ProvidersWithHttpInfoAsync(System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
