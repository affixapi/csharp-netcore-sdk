...
namespace AffixApi.Api.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = "OpenAPI-Generator/1.1.43/csharp";
        ...
        public Configuration(
            ...
            string basePath = "https://api.affixapi.com") : this()
        {
        ...
        {
            String report = "C# SDK (AffixApi.Api) Debug Report:\n";
            report += "    OS: " + System.Environment.OSVersion + "\n";
            report += "    .NET Framework Version: " + System.Environment.Version  + "\n";
            report += "    Version of the API: 2023-03-01\n";
            report += "    SDK Package Version: 1.1.43\n";
