...
namespace AffixApi.Api.Model
{
    ...
    /// ClientRequest
    /// </summary>
    [DataContract(Name = "ClientRequest")]
    public partial class ClientRequest : IEquatable<ClientRequest>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="ClientRequest" /> class.
        /// </summary>
        /// <param name="clientSecret">The client secret(s). It is an array datatype to allow for rotation of secrets without downtime for your customers  (required).</param>
        /// <param name="redirectUris">Indicates the URI to return the user to after authorization is complete, which is the endpoint on your server to receive the authorization_code.  Must be identical to the redirect URI provided in the original link.  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out.  (required).</param>
        /// <param name="name">Name of your app that shows up in the Affix Connect application  (required).</param>
        /// <param name="webhookUri">If enabled, webhooks will be sent to this endpoint .</param>
        public ClientRequest(List<string> clientSecret = default(List<string>), List<string> redirectUris = default(List<string>), string name = default(string), string webhookUri = default(string))
        {
            // to ensure "clientSecret" is required (not null)
            this.ClientSecret = clientSecret ?? throw new ArgumentNullException("clientSecret is a required property for ClientRequest and cannot be null");
            // to ensure "redirectUris" is required (not null)
            this.RedirectUris = redirectUris ?? throw new ArgumentNullException("redirectUris is a required property for ClientRequest and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ClientRequest and cannot be null");
        ...
        /// </summary>
        /// <value>The client secret(s). It is an array datatype to allow for rotation of secrets without downtime for your customers </value>
        [DataMember(Name = "client_secret", IsRequired = true, EmitDefaultValue = false)]
        public List<string> ClientSecret { get; set; }
        ...
        /// </summary>
        /// <value>Indicates the URI to return the user to after authorization is complete, which is the endpoint on your server to receive the authorization_code.  Must be identical to the redirect URI provided in the original link.  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out. </value>
        [DataMember(Name = "redirect_uris", IsRequired = true, EmitDefaultValue = false)]
        public List<string> RedirectUris { get; set; }

        /// <summary>
        /// Name of your app that shows up in the Affix Connect application 
        /// </summary>
        /// <value>Name of your app that shows up in the Affix Connect application </value>
        ...
        /// </summary>
        /// <value>If enabled, webhooks will be sent to this endpoint </value>
        [DataMember(Name = "webhook_uri", EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as ClientRequest);
        }

        /// <summary>
        /// Returns true if ClientRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ClientRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ClientRequest input)
        {
            if (input == null)
                return false;
            ...
            return 
                (
                    ...
                    this.ClientSecret.SequenceEqual(input.ClientSecret)
                ) && 
                (
                ...
                (
                    this.WebhookUri == input.WebhookUri ||
                    (this.WebhookUri != null &&
                    this.WebhookUri.Equals(input.WebhookUri))
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.WebhookUri != null)
                    hashCode = hashCode * 59 + this.WebhookUri.GetHashCode();
                return hashCode;
            }
        }
