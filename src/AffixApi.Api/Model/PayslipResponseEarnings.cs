...
namespace AffixApi.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayslipResponse_earnings")]
    public partial class PayslipResponseEarnings : IEquatable<PayslipResponseEarnings>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayslipResponseEarnings" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayslipResponseEarnings() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayslipResponseEarnings" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="amount">if USD/EUR/GBP, in cent (required).</param>
        /// <param name="hours">hours, if applicable (required).</param>
        public PayslipResponseEarnings(string name = default(string), decimal amount = default(decimal), decimal? hours = default(decimal?))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for PayslipResponseEarnings and cannot be null");
            this.Amount = amount;
            // to ensure "hours" is required (not null)
            this.Hours = hours ?? throw new ArgumentNullException("hours is a required property for PayslipResponseEarnings and cannot be null");
        }
        ...
        /// hours, if applicable
        /// </summary>
        /// <value>hours, if applicable</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayslipResponseEarnings {\n");
        ...
        {
            return this.Equals(input as PayslipResponseEarnings);
        }

        /// <summary>
        /// Returns true if PayslipResponseEarnings instances are equal
        /// </summary>
        /// <param name="input">Instance of PayslipResponseEarnings to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayslipResponseEarnings input)
        {
            if (input == null)
                return false;
