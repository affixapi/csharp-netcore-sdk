...
namespace AffixApi.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayslipResponse_deductions")]
    public partial class PayslipResponseDeductions : IEquatable<PayslipResponseDeductions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayslipResponseDeductions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayslipResponseDeductions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayslipResponseDeductions" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="amount">if USD/EUR/GBP, in cent (required).</param>
        public PayslipResponseDeductions(string name = default(string), decimal amount = default(decimal))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for PayslipResponseDeductions and cannot be null");
            this.Amount = amount;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayslipResponseDeductions {\n");
        ...
        {
            return this.Equals(input as PayslipResponseDeductions);
        }

        /// <summary>
        /// Returns true if PayslipResponseDeductions instances are equal
        /// </summary>
        /// <param name="input">Instance of PayslipResponseDeductions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayslipResponseDeductions input)
        {
            if (input == null)
                return false;
