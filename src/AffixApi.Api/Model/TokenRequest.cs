...
namespace AffixApi.Api.Model
{
    ...
    public partial class TokenRequest : IEquatable<TokenRequest>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>This is a hardcoded value required by the OAuth 2.1 spec</value>
        ...
        /// Initializes a new instance of the <see cref="TokenRequest" /> class.
        /// </summary>
        /// <param name="clientId">The client ID you received when you first created the application (required).</param>
        /// <param name="clientSecret">The client secret. Since there can be multiple &#x60;client_secret&#x60;s (to allow for rotation of secrets without downtime to your customers), any current &#x60;client_secret&#x60; is valid  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out.  (required).</param>
        /// <param name="grantType">This is a hardcoded value required by the OAuth 2.1 spec (required).</param>
        /// <param name="code">This is the code you received in the query string (required).</param>
        /// <param name="redirectUri">Indicates the URI to return the user to after authorization is complete, which is the endpoint on your server to receive the authorization_code.  Must be identical to the redirect URI provided in the original link.  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out.  (required).</param>
        public TokenRequest(string clientId = default(string), string clientSecret = default(string), GrantTypeEnum grantType = default(GrantTypeEnum), string code = default(string), string redirectUri = default(string))
        {
            // to ensure "clientId" is required (not null)
            this.ClientId = clientId ?? throw new ArgumentNullException("clientId is a required property for TokenRequest and cannot be null");
            // to ensure "clientSecret" is required (not null)
            this.ClientSecret = clientSecret ?? throw new ArgumentNullException("clientSecret is a required property for TokenRequest and cannot be null");
            this.GrantType = grantType;
            // to ensure "code" is required (not null)
            this.Code = code ?? throw new ArgumentNullException("code is a required property for TokenRequest and cannot be null");
            // to ensure "redirectUri" is required (not null)
            this.RedirectUri = redirectUri ?? throw new ArgumentNullException("redirectUri is a required property for TokenRequest and cannot be null");
        }
        ...
        /// </summary>
        /// <value>The client secret. Since there can be multiple &#x60;client_secret&#x60;s (to allow for rotation of secrets without downtime to your customers), any current &#x60;client_secret&#x60; is valid  Please email me after signup and I will set both your client secret and redirect_uri (required) when you reach out. </value>
        ...
        /// </summary>
        /// <value>This is the code you received in the query string</value>
