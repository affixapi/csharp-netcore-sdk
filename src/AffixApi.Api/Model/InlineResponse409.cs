...
namespace AffixApi.Api.Model
{
    ...
    public partial class InlineResponse409 : IEquatable<InlineResponse409>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The description of the type of error, ie conflict of two requests of the the same authorization code </value>
        ...
        /// Initializes a new instance of the <see cref="InlineResponse409" /> class.
        /// </summary>
        /// <param name="code">The authorization code insert that caused a conflict .</param>
        /// <param name="token">The access token insert that caused a conflict .</param>
        /// <param name="error">The description of the type of error, ie conflict of two requests of the the same authorization code  (required).</param>
        public InlineResponse409(string code = default(string), string token = default(string), ErrorEnum error = default(ErrorEnum))
        {
            this.Error = error;
            this.Code = code;
            this.Token = token;
        ...
        /// </summary>
        /// <value>The authorization code insert that caused a conflict </value>
        ...
        /// </summary>
        /// <value>The access token insert that caused a conflict </value>
