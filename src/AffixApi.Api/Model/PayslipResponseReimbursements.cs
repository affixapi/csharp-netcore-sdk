...
namespace AffixApi.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayslipResponse_reimbursements")]
    public partial class PayslipResponseReimbursements : IEquatable<PayslipResponseReimbursements>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayslipResponseReimbursements" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayslipResponseReimbursements() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayslipResponseReimbursements" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="amount">if USD/EUR/GBP, in cent (required).</param>
        public PayslipResponseReimbursements(string name = default(string), decimal amount = default(decimal))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for PayslipResponseReimbursements and cannot be null");
            this.Amount = amount;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayslipResponseReimbursements {\n");
        ...
        {
            return this.Equals(input as PayslipResponseReimbursements);
        }

        /// <summary>
        /// Returns true if PayslipResponseReimbursements instances are equal
        /// </summary>
        /// <param name="input">Instance of PayslipResponseReimbursements to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayslipResponseReimbursements input)
        {
            if (input == null)
                return false;
