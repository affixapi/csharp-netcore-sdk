...
namespace AffixApi.Api.Model
{
    ...
    public partial class TokenResponse : IEquatable<TokenResponse>, IValidatableObject
    {
        ...
        /// </summary>
        /// <value>The token type to pass in the &#x60;Authorization&#x60; header</value>
        ...
        public TokenResponse(ModeResponse mode = default(ModeResponse), ProviderResponse provider = default(ProviderResponse))
        {
            this.Mode = mode;
        ...
        /// </summary>
        /// <value>The issued access_token</value>
