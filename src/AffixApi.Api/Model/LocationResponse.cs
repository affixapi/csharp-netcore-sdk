...
namespace AffixApi.Api.Model
{
    ...
    public partial class LocationResponse : IEquatable<LocationResponse>, IValidatableObject
    {
        ...
        public LocationResponse(string id = default(string), string remoteId = default(string), string name = default(string), string type = default(string), AddressResponse address = default(AddressResponse))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for LocationResponse and cannot be null");
            // to ensure "remoteId" is required (not null)
            this.RemoteId = remoteId ?? throw new ArgumentNullException("remoteId is a required property for LocationResponse and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for LocationResponse and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for LocationResponse and cannot be null");
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for LocationResponse and cannot be null");
        }
