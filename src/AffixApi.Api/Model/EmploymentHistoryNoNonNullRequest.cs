...
namespace AffixApi.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "employment-history-no-non-nullRequest")]
    public partial class EmploymentHistoryNoNonNullRequest : IEquatable<EmploymentHistoryNoNonNullRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EmploymentHistoryNoNonNullRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected EmploymentHistoryNoNonNullRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="EmploymentHistoryNoNonNullRequest" /> class.
        /// </summary>
        ...
        public EmploymentHistoryNoNonNullRequest(string jobTitle = default(string), DateTime effectiveDate = default(DateTime), string groupId = default(string), string groupRemoteId = default(string), string groupName = default(string), string managerId = default(string), string managerRemoteId = default(string))
        {
            ...
            this.GroupId = groupId ?? throw new ArgumentNullException("groupId is a required property for EmploymentHistoryNoNonNullRequest and cannot be null");
        ...
        /// </summary>
        [DataMember(Name = "job_title", IsRequired = true, EmitDefaultValue = false)]
        public string JobTitle { get; set; }

        /// <summary>
        /// Gets or Sets EffectiveDate
        /// </summary>
        [DataMember(Name = "effective_date", IsRequired = true, EmitDefaultValue = false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EmploymentHistoryNoNonNullRequest {\n");
        ...
        {
            return this.Equals(input as EmploymentHistoryNoNonNullRequest);
        }

        /// <summary>
        /// Returns true if EmploymentHistoryNoNonNullRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of EmploymentHistoryNoNonNullRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EmploymentHistoryNoNonNullRequest input)
        {
            if (input == null)
                return false;
