...
namespace AffixApi.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "IdAndMessageResponse")]
    public partial class IdAndMessageResponse : IEquatable<IdAndMessageResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IdAndMessageResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected IdAndMessageResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="IdAndMessageResponse" /> class.
        /// </summary>
        /// <param name="message">A description of the error (required).</param>
        /// <param name="id">The id of the entity that the id applies. For example, the transaction id (required).</param>
        public IdAndMessageResponse(string message = default(string), string id = default(string))
        {
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for IdAndMessageResponse and cannot be null");
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for IdAndMessageResponse and cannot be null");
        }
        ...
        /// </summary>
        /// <value>The id of the entity that the id applies. For example, the transaction id</value>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class IdAndMessageResponse {\n");
        ...
        {
            return this.Equals(input as IdAndMessageResponse);
        }

        /// <summary>
        /// Returns true if IdAndMessageResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IdAndMessageResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IdAndMessageResponse input)
        {
            if (input == null)
                return false;
