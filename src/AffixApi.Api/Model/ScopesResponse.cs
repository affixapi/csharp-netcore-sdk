...
namespace AffixApi.Api.Model
{
    ...
    public enum ScopesResponse
    {
        ...
        /// <summary>
        /// Enum XhrCompany for value: /2023-03-01/xhr/company
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/company")]
        XhrCompany = 10,

        /// <summary>
        /// Enum XhrEmployee for value: /2023-03-01/xhr/employee
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/employee")]
        XhrEmployee = 11,

        /// <summary>
        /// Enum XhrEmployees for value: /2023-03-01/xhr/employees
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/employees")]
        XhrEmployees = 12,

        /// <summary>
        /// Enum XhrGroups for value: /2023-03-01/xhr/groups
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/groups")]
        XhrGroups = 13,

        /// <summary>
        /// Enum XhrIdentity for value: /2023-03-01/xhr/identity
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/identity")]
        XhrIdentity = 14,

        /// <summary>
        /// Enum XhrPayruns for value: /2023-03-01/xhr/payruns
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/payruns")]
        XhrPayruns = 15,

        /// <summary>
        /// Enum XhrPayrunspayrunId for value: /2023-03-01/xhr/payruns/:payrun_id
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/payruns/:payrun_id")]
        XhrPayrunspayrunId = 16,

        /// <summary>
        /// Enum XhrTimeOffBalances for value: /2023-03-01/xhr/time-off-balances
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/time-off-balances")]
        XhrTimeOffBalances = 17,

        /// <summary>
        /// Enum XhrTimeOffEntries for value: /2023-03-01/xhr/time-off-entries
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/time-off-entries")]
        XhrTimeOffEntries = 18,

        /// <summary>
        /// Enum XhrTimesheets for value: /2023-03-01/xhr/timesheets
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/timesheets")]
        XhrTimesheets = 19,

        /// <summary>
        /// Enum XhrWorkLocations for value: /2023-03-01/xhr/work-locations
        /// </summary>
        [EnumMember(Value = "/2023-03-01/xhr/work-locations")]
        XhrWorkLocations = 20
