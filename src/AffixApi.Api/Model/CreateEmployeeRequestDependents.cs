...
namespace AffixApi.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateEmployeeRequest_dependents")]
    public partial class CreateEmployeeRequestDependents : IEquatable<CreateEmployeeRequestDependents>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmployeeRequestDependents" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateEmployeeRequestDependents() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmployeeRequestDependents" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="relationship">relationship (required).</param>
        public CreateEmployeeRequestDependents(string name = default(string), string relationship = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for CreateEmployeeRequestDependents and cannot be null");
            // to ensure "relationship" is required (not null)
            this.Relationship = relationship ?? throw new ArgumentNullException("relationship is a required property for CreateEmployeeRequestDependents and cannot be null");
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class CreateEmployeeRequestDependents {\n");
        ...
        {
            return this.Equals(input as CreateEmployeeRequestDependents);
        }

        /// <summary>
        /// Returns true if CreateEmployeeRequestDependents instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateEmployeeRequestDependents to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateEmployeeRequestDependents input)
        {
            if (input == null)
                return false;
