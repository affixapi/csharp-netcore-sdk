...
namespace AffixApi.Api.Model
{
    ...
    public partial class ClientResponse : IEquatable<ClientResponse>, IValidatableObject
    {
        ...
        public ClientResponse(List<string> clientSecret = default(List<string>), List<string> redirectUris = default(List<string>), string name = default(string), string webhookUri = default(string))
        {
            // to ensure "clientSecret" is required (not null)
            this.ClientSecret = clientSecret ?? throw new ArgumentNullException("clientSecret is a required property for ClientResponse and cannot be null");
            // to ensure "redirectUris" is required (not null)
            this.RedirectUris = redirectUris ?? throw new ArgumentNullException("redirectUris is a required property for ClientResponse and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for ClientResponse and cannot be null");
