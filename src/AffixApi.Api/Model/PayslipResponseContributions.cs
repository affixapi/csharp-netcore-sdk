...
namespace AffixApi.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "PayslipResponse_contributions")]
    public partial class PayslipResponseContributions : IEquatable<PayslipResponseContributions>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="PayslipResponseContributions" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected PayslipResponseContributions() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="PayslipResponseContributions" /> class.
        /// </summary>
        /// <param name="name">name (required).</param>
        /// <param name="amount">if USD/EUR/GBP, in cent (required).</param>
        public PayslipResponseContributions(string name = default(string), decimal amount = default(decimal))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for PayslipResponseContributions and cannot be null");
            this.Amount = amount;
        }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class PayslipResponseContributions {\n");
        ...
        {
            return this.Equals(input as PayslipResponseContributions);
        }

        /// <summary>
        /// Returns true if PayslipResponseContributions instances are equal
        /// </summary>
        /// <param name="input">Instance of PayslipResponseContributions to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayslipResponseContributions input)
        {
            if (input == null)
                return false;
