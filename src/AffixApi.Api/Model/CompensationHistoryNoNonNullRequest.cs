...
namespace AffixApi.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "compensation-history-no-non-nullRequest")]
    public partial class CompensationHistoryNoNonNullRequest : IEquatable<CompensationHistoryNoNonNullRequest>, IValidatableObject
    {
        /// <summary>
        ...
        protected CompensationHistoryNoNonNullRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CompensationHistoryNoNonNullRequest" /> class.
        /// </summary>
        ...
        public CompensationHistoryNoNonNullRequest(decimal payRate = default(decimal), string payPeriod = default(string), PayFrequencyEnum payFrequency = default(PayFrequencyEnum), EmploymentTypeEnum employmentType = default(EmploymentTypeEnum), CurrencyNotNullRequest currency = default(CurrencyNotNullRequest), DateTime effectiveDate = default(DateTime), string notes = default(string))
        {
            ...
            this.Notes = notes ?? throw new ArgumentNullException("notes is a required property for CompensationHistoryNoNonNullRequest and cannot be null");
        }

        /// <summary>
        /// Gets or Sets PayRate
        /// </summary>
        [DataMember(Name = "pay_rate", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as CompensationHistoryNoNonNullRequest);
        }

        /// <summary>
        /// Returns true if CompensationHistoryNoNonNullRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of CompensationHistoryNoNonNullRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CompensationHistoryNoNonNullRequest input)
        {
            if (input == null)
                return false;
