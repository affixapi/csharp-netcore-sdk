...
namespace AffixApi.Api.Model
{
    ...
    public partial class GroupResponse : IEquatable<GroupResponse>, IValidatableObject
    {
        ...
        public GroupResponse(string id = default(string), string remoteId = default(string), string name = default(string), TypeEnum type = default(TypeEnum))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for GroupResponse and cannot be null");
            // to ensure "remoteId" is required (not null)
            this.RemoteId = remoteId ?? throw new ArgumentNullException("remoteId is a required property for GroupResponse and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for GroupResponse and cannot be null");
            this.Type = type;
        }
