...
namespace AffixApi.Api.Model
{
    ...
    /// </summary>
    [DataContract(Name = "CreateEmployeeRequest_bank_account")]
    public partial class CreateEmployeeRequestBankAccount : IEquatable<CreateEmployeeRequestBankAccount>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmployeeRequestBankAccount" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected CreateEmployeeRequestBankAccount() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateEmployeeRequestBankAccount" /> class.
        /// </summary>
        /// <param name="accountNumber">accountNumber (required).</param>
        /// <param name="bankName">bankName (required).</param>
        /// <param name="bic">bic (required).</param>
        /// <param name="holderName">holderName (required).</param>
        /// <param name="iban">iban (required).</param>
        public CreateEmployeeRequestBankAccount(string accountNumber = default(string), string bankName = default(string), string bic = default(string), string holderName = default(string), string iban = default(string))
        {
            // to ensure "accountNumber" is required (not null)
            this.AccountNumber = accountNumber ?? throw new ArgumentNullException("accountNumber is a required property for CreateEmployeeRequestBankAccount and cannot be null");
            // to ensure "bankName" is required (not null)
            this.BankName = bankName ?? throw new ArgumentNullException("bankName is a required property for CreateEmployeeRequestBankAccount and cannot be null");
            // to ensure "bic" is required (not null)
            this.Bic = bic ?? throw new ArgumentNullException("bic is a required property for CreateEmployeeRequestBankAccount and cannot be null");
            // to ensure "holderName" is required (not null)
            this.HolderName = holderName ?? throw new ArgumentNullException("holderName is a required property for CreateEmployeeRequestBankAccount and cannot be null");
            // to ensure "iban" is required (not null)
            this.Iban = iban ?? throw new ArgumentNullException("iban is a required property for CreateEmployeeRequestBankAccount and cannot be null");
        }
        ...
        /// Gets or Sets Bic
        /// </summary>
        [DataMember(Name = "bic", IsRequired = true, EmitDefaultValue = true)]
        public string Bic { get; set; }

        /// <summary>
        /// Gets or Sets HolderName
        /// </summary>
        [DataMember(Name = "holder_name", IsRequired = true, EmitDefaultValue = true)]
        ...
        {
            return this.Equals(input as CreateEmployeeRequestBankAccount);
        }

        /// <summary>
        /// Returns true if CreateEmployeeRequestBankAccount instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateEmployeeRequestBankAccount to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateEmployeeRequestBankAccount input)
        {
            if (input == null)
                return false;
