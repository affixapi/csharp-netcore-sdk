...
namespace AffixApi.Api.Model
{
    ...
    /// TimesheetResponse
    /// </summary>
    [DataContract(Name = "TimesheetResponse")]
    public partial class TimesheetResponse : IEquatable<TimesheetResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TimesheetResponse" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TimesheetResponse() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TimesheetResponse" /> class.
        /// </summary>
        ...
        public TimesheetResponse(string id = default(string), string remoteId = default(string), string employeeId = default(string), string employeeRemoteId = default(string), DateTime? startTime = default(DateTime?), DateTime? endTime = default(DateTime?), decimal hoursWorked = default(decimal), DateTime? remoteCreatedAt = default(DateTime?), DateTime? remoteModifiedAt = default(DateTime?))
        {
            ...
            this.EmployeeRemoteId = employeeRemoteId ?? throw new ArgumentNullException("employeeRemoteId is a required property for TimesheetResponse and cannot be null");
            ...
            this.EndTime = endTime ?? throw new ArgumentNullException("endTime is a required property for TimesheetResponse and cannot be null");
            this.HoursWorked = hoursWorked;
            // to ensure "remoteCreatedAt" is required (not null)
            this.RemoteCreatedAt = remoteCreatedAt ?? throw new ArgumentNullException("remoteCreatedAt is a required property for TimesheetResponse and cannot be null");
            // to ensure "remoteModifiedAt" is required (not null)
            this.RemoteModifiedAt = remoteModifiedAt ?? throw new ArgumentNullException("remoteModifiedAt is a required property for TimesheetResponse and cannot be null");
        }
        ...
        /// </summary>
        [DataMember(Name = "hours_worked", IsRequired = true, EmitDefaultValue = false)]
        ...
        {
            return this.Equals(input as TimesheetResponse);
        }

        /// <summary>
        /// Returns true if TimesheetResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of TimesheetResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TimesheetResponse input)
        {
            if (input == null)
                return false;
