...
namespace AffixApi.Api.Model
{
    ...
    /// DisconnectResponse
    /// </summary>
    [DataContract(Name = "DisconnectResponse")]
    public partial class DisconnectResponse : IEquatable<DisconnectResponse>, IValidatableObject
    {
        /// <summary>
        /// The access token has been disconnected and is no longer allowed to be used by your application
        /// </summary>
        /// <value>The access token has been disconnected and is no longer allowed to be used by your application</value>
        [JsonConverter(typeof(StringEnumConverter))]
        public enum DisconnectedEnum
        {
            /// <summary>
        ...
        public DisconnectedEnum Disconnected { get; set; }

        /// <summary>
        /// Returns false as Disconnected should not be serialized given that it's read-only.
        /// </summary>
        /// <returns>false (boolean)</returns>
        public bool ShouldSerializeDisconnected()
        {
            return false;
        }
        /// <summary>
        ...
        public override string ToString()
        {
            ...
            sb.Append("class DisconnectResponse {\n");
        ...
        {
            return this.Equals(input as DisconnectResponse);
        }

        /// <summary>
        /// Returns true if DisconnectResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of DisconnectResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(DisconnectResponse input)
        {
            if (input == null)
                return false;
