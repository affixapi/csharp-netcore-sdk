...
namespace Org.OpenAPITools.Model
{
    ...
    /// PayrunResponse
    /// </summary>
    [DataContract(Name = "PayrunResponse")]
    public partial class PayrunResponse : IEquatable<PayrunResponse>, IValidatableObject
    {
        ...
        public PayrunResponse(string id = default(string), string remoteId = default(string), RunStateEnum runState = default(RunStateEnum), RunTypeEnum runType = default(RunTypeEnum), DateTime? startDate = default(DateTime?), DateTime? endDate = default(DateTime?), DateTime? paymentDate = default(DateTime?))
        {
            ...
            this.EndDate = endDate ?? throw new ArgumentNullException("endDate is a required property for PayrunResponse and cannot be null");
            // to ensure "paymentDate" is required (not null)
            this.PaymentDate = paymentDate ?? throw new ArgumentNullException("paymentDate is a required property for PayrunResponse and cannot be null");
        }
        ...
        /// </summary>
        /// <value>Payrun period start date</value>
        ...
        /// </summary>
        /// <value>Payrun period end date</value>
        ...
        /// </summary>
        /// <value>Payment date / check date</value>
        ...
        {
            return this.Equals(input as PayrunResponse);
        }

        /// <summary>
        /// Returns true if PayrunResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of PayrunResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(PayrunResponse input)
        {
            if (input == null)
                return false;
