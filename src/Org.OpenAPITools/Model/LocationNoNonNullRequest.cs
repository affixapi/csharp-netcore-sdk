...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract(Name = "location-no-non-nullRequest")]
    public partial class LocationNoNonNullRequest : IEquatable<LocationNoNonNullRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationNoNonNullRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected LocationNoNonNullRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="LocationNoNonNullRequest" /> class.
        /// </summary>
        ...
        /// <param name="name">System assigned description of the location (required).</param>
        /// <param name="type">The location&#39;s type. In cases where there is no clear mapping, the original value passed through will be returned.  (required).</param>
        /// <param name="address">address (required).</param>
        public LocationNoNonNullRequest(string id = default(string), string remoteId = default(string), string name = default(string), string type = default(string), AddressNoNonNullRequest address = default(AddressNoNonNullRequest))
        {
            // to ensure "id" is required (not null)
            this.Id = id ?? throw new ArgumentNullException("id is a required property for LocationNoNonNullRequest and cannot be null");
            // to ensure "remoteId" is required (not null)
            this.RemoteId = remoteId ?? throw new ArgumentNullException("remoteId is a required property for LocationNoNonNullRequest and cannot be null");
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for LocationNoNonNullRequest and cannot be null");
            // to ensure "type" is required (not null)
            this.Type = type ?? throw new ArgumentNullException("type is a required property for LocationNoNonNullRequest and cannot be null");
            // to ensure "address" is required (not null)
            this.Address = address ?? throw new ArgumentNullException("address is a required property for LocationNoNonNullRequest and cannot be null");
        }
        ...
        /// </summary>
        /// <value>System assigned description of the location</value>
        ...
        /// </summary>
        /// <value>The location&#39;s type. In cases where there is no clear mapping, the original value passed through will be returned. </value>
        ...
        public AddressNoNonNullRequest Address { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("class LocationNoNonNullRequest {\n");
        ...
        {
            return this.Equals(input as LocationNoNonNullRequest);
        }

        /// <summary>
        /// Returns true if LocationNoNonNullRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of LocationNoNonNullRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(LocationNoNonNullRequest input)
        {
            if (input == null)
                return false;
