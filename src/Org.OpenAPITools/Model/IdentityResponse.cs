...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class IdentityResponse : IEquatable<IdentityResponse>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="IdentityResponse" /> class.
        /// </summary>
        /// <param name="name">The name of the individual for the respective account, if known (required).</param>
        /// <param name="email">The email of the individual for the respective account, if known (required).</param>
        /// <param name="phoneNumber">The phone number of the individual for the respective account, if known. Nullable for tokens created prior to 2023-03-05  (required).</param>
        public IdentityResponse(string name = default(string), string email = default(string), string phoneNumber = default(string))
        {
            // to ensure "name" is required (not null)
            this.Name = name ?? throw new ArgumentNullException("name is a required property for IdentityResponse and cannot be null");
            // to ensure "email" is required (not null)
            this.Email = email ?? throw new ArgumentNullException("email is a required property for IdentityResponse and cannot be null");
            // to ensure "phoneNumber" is required (not null)
            this.PhoneNumber = phoneNumber ?? throw new ArgumentNullException("phoneNumber is a required property for IdentityResponse and cannot be null");
        }

        /// <summary>
        /// The name of the individual for the respective account, if known
        /// </summary>
        /// <value>The name of the individual for the respective account, if known</value>
        ...
        /// </summary>
        /// <value>The email of the individual for the respective account, if known</value>
        ...
        /// </summary>
        /// <value>The phone number of the individual for the respective account, if known. Nullable for tokens created prior to 2023-03-05 </value>
