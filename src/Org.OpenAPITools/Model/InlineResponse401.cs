...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse401 : IEquatable<InlineResponse401>, IValidatableObject
    {
        ...
        {
            /// <summary>
            /// Enum IncorrectUsernameOrPassword for value: incorrect_username_or_password
            /// </summary>
            [EnumMember(Value = "incorrect_username_or_password")]
            IncorrectUsernameOrPassword = 1,

            /// <summary>
            /// Enum IncorrectMfaOrOtp for value: incorrect_mfa_or_otp
            /// </summary>
            [EnumMember(Value = "incorrect_mfa_or_otp")]
            IncorrectMfaOrOtp = 2,

            /// <summary>
            /// Enum ReauthenticationRequiredCookiesAreNowExpired for value: reauthentication_required // cookies are now expired
            /// </summary>
            [EnumMember(Value = "reauthentication_required // cookies are now expired")]
            ReauthenticationRequiredCookiesAreNowExpired = 3,

            /// <summary>
            /// Enum AdditionalAccountSetupRequiredPasswordResetEtc for value: additional_account_setup_required // password reset, etc
            /// </summary>
            [EnumMember(Value = "additional_account_setup_required // password reset, etc")]
            AdditionalAccountSetupRequiredPasswordResetEtc = 4,

            /// <summary>
            /// Enum CaptchaChallengeAmazonType1CaptchaChallengecurrentlyUnsovable for value: captcha_challenge // amazon type1 captcha challenge (currently unsovable)
            /// </summary>
            [EnumMember(Value = "captcha_challenge // amazon type1 captcha challenge (currently unsovable)")]
            CaptchaChallengeAmazonType1CaptchaChallengecurrentlyUnsovable = 5,

            /// <summary>
            /// Enum NoValidAccountsNotUsedCurrentlyButReservedForFutureUse for value: no_valid_accounts // not used currently but reserved for future use
            /// </summary>
            [EnumMember(Value = "no_valid_accounts // not used currently but reserved for future use")]
            NoValidAccountsNotUsedCurrentlyButReservedForFutureUse = 6,

            /// <summary>
            /// Enum InsufficientPermissionNotEnoughPrivilegesieNotAnAdminOrNotEnoughProviderScopesOnAProviderApiTokenForTheAffixScopesRequested for value: insufficient_permission // not enough privileges (ie not an admin, or not enough provider scopes on a provider api token for the Affix scopes requested)
            /// </summary>
            [EnumMember(Value = "insufficient_permission // not enough privileges (ie not an admin, or not enough provider scopes on a provider api token for the Affix scopes requested)")]
            InsufficientPermissionNotEnoughPrivilegesieNotAnAdminOrNotEnoughProviderScopesOnAProviderApiTokenForTheAffixScopesRequested = 7
        ...
        protected InlineResponse401() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="InlineResponse401" /> class.
        /// </summary>
        /// <param name="error">The type of error (required).</param>
        /// <param name="message">A descriptive description of the error  (required).</param>
        /// <param name="code">code (required).</param>
        public InlineResponse401(ErrorEnum error = default(ErrorEnum), string message = default(string), CodeEnum code = default(CodeEnum))
        {
            this.Error = error;
            // to ensure "message" is required (not null)
            this.Message = message ?? throw new ArgumentNullException("message is a required property for InlineResponse401 and cannot be null");
            this.Code = code;
        }
        ...
        /// </summary>
        /// <value>A descriptive description of the error </value>
